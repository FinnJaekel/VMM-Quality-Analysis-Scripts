...
fname = 'adccalibdata_ext_new.txt'
ally = np.empty(0)
allx = np.empty(0)
alla = np.empty(0)
allb = np.empty(0)
...
hardbins= [-0.08463212, -0.08314301, -0.0816539 , -0.08016479, -0.07867567,
       ...
       -0.05484988]
plt.hist(alla,bins=hardbins,label='Data')
counts,bins = np.histogram(alla,bins=hardbins)
...
fitx = np.linspace(-0.09,-0.04,100)
...
plt.legend()
plt.grid(linestyle = ':')
plt.savefig('ADCCalExtCurve.pdf')
...
hardbins = [28.36652919, 28.76392011, 29.16131103, 29.55870195, 29.95609287,
       ...
       40.28825684]
plt.hist(allcents,bins=hardbins,color = 'red',label='Data')
counts,bins = np.histogram(allcents,bins=hardbins)
...
plt.legend()
plt.grid(linestyle = ':')
plt.savefig('ADCCalExtCenter.pdf')
...
plt.hist(allmax,bins=hardbins,color= 'green',label='Data')
counts,bins = np.histogram(allmax,bins=hardbins)
...
plt.legend()
plt.grid(linestyle = ':')
plt.savefig('ADCCalExtHeight.pdf')
...
plt.grid(linestyle = ':')
plt.savefig('ADCCalExtOptParabola.pdf')
...
plt.ylabel('Count N')
plt.legend()
plt.savefig('ADCCalExtDeviations.pdf')
# ~ plt.figure(1)
